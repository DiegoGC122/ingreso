...
def _load_correos_jefes():
    ...
    try:
        ...
        if "CORREOS_JEFES" in st.secrets:
            ...
            # Si viene como dict en secrets.toml, úsalo directo.
    ...
    # 3) Por defecto vacío (evita ImportError)
    return {}
...
# Alias útiles si tu código los espera en otros lugares (opcional):
# CORREOS_APROBADORES = CORREOS_JEFES
